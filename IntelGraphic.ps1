...
New-EventLog -LogName Application -Source "OCC Prep"
Write-Eventlog -LogName "Application" -Source "OCC Prep" -EventID 999  -EntryType Error -Message "Failed to set Intel registry ID; Drivers may not be installed" -Category 1 -RawData 10,20 
Write-Eventlog -LogName "Application" -Source "OCC Prep" -EventID 999  -EntryType Error -Message "Contents of 0 is $IDcheck0 " -Category 1 -RawData 10,20 
Write-Eventlog -LogName "Application" -Source "OCC Prep" -EventID 999  -EntryType Error -Message "Contents of 1 is $IDcheck1 " -Category 1 -RawData 10,20 
[Environment]::Exit(1)
}
